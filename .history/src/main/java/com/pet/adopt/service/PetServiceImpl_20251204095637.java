...
public class PetServiceImpl implements PetService {
    ...
    public boolean updatePet(Pet pet) {
        if (pet == null || pet.getId() == null || pet.getUserId() == null) {
            return false;
        }
    ...
    public boolean deletePet(Integer petId, Integer userId) {
        ...
        return petDao.deletePet(petId, userId);
    }
    ...
    public boolean deletePetByAdmin(Integer petId) {
        ...
        PetDaoImpl petDaoImpl = (PetDaoImpl) petDao;
        return petDaoImpl.deletePetByAdmin(petId);
    }
