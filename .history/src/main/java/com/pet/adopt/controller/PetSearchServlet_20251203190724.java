...
public class PetSearchServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            e.printStackTrace();
            String msg = "图片上传失败：" + e.getMessage();
            if (isAjax) {
                writeJson(resp, false, msg);
            } else {
                req.setAttribute("error", msg);
    ...
    // ========== 私有方法：新增寻宠信息到数据库 ==========
    // 修复方法参数，增加gender参数，并通过 errorMsg 把异常信息回传给上层
    private boolean addPetSearch(String name, String type, String location, LocalDateTime lostTime,
                                 ...
                                 Integer age, String gender, StringBuilder errorMsg) {
