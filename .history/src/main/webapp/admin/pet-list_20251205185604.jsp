                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                            ...
                                            data-pet-name="${empty pet.name ? '该宠物' : fn:escapeXml(pet.name)}"
...
<script>
    ...
    function confirmDeletePet(btn) {
        ...
        const rawName = btn.dataset.petName || btn.getAttribute('data-pet-name') || '';
        const name = rawName && rawName.trim().length > 0 ? rawName.trim() : '该宠物';
