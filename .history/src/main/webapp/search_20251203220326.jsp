                                ...
                                <div class="modal-content" style="border-radius: 16px;">
                                    <div class="modal-header border-0">
                                        <h5 class="modal-title">
                                            <i class="bi bi-${data.success ? 'check-circle-fill text-success' : 'exclamation-circle-fill text-danger'} me-2"></i>
                                            ${data.success ? '发布成功' : '发布失败'}
                                        </h5>
                                    ...
                                    <div class="modal-footer border-0">
                                        <button type="button" class="btn btn-${data.success ? 'success' : 'danger'}" data-bs-dismiss="modal">知道啦</button>
                                    </div>
                                </div>
                            </div>
                        </div>`;
