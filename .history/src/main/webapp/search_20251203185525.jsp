...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const alertEl = document.getElementById('publishSuccessAlert');
        if (alertEl) {
            // 使用 Bootstrap 提示框或原生弹窗，这里使用优雅的模态框
            const msg = alertEl.getAttribute('data-success-msg') || '寻宠信息发布成功！';
                        ...
                        <div class="modal-content" style="border-radius: 16px;">
                            <div class="modal-header border-0">
                                <h5 class="modal-title">
                                    <i class="bi bi-check-circle-fill me-2 text-success"></i>发布成功
                                </h5>
                            ...
                            <div class="modal-footer border-0">
                                <button type="button" class="btn btn-success" data-bs-dismiss="modal">知道啦</button>
                            </div>
                        </div>
                    </div>
                </div>`;
