                    ...
                    <div class="card-body p-5">
                        <c:if test="${empty sessionScope.userId}">
                            <div class="alert alert-warning">
                                ...
                                <strong>提示：</strong>您需要先<a href="${pageContext.request.contextPath}/login.jsp?redirect=${pageContext.request.contextPath}/add.jsp" class="alert-link">登录</a>才能提交领养信息。
                            </div>
                        </c:if>
